package com.example.quantityapp.QuantityApp;
...
public class TargetUnitAddition {
    ...
    public TargetUnitAddition add(TargetUnitAddition other) {
        if(other == null) {
    ...
    public boolean equals(Object obj) {
        ...
        TargetUnitAddition other = (TargetUnitAddition) obj;

        return this.unit == other.unit && Math.abs(this.value - other.value) < EPSILON;
    }
