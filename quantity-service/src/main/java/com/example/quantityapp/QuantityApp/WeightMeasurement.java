...
enum WeightUnit {
	 ...
	 // Converting value in this unit to base unit (Kilogram)
	 public double convertToBaseUnit(double value) {
	     return value * toKilogramFactor;
	 }
	
	 // Converting from base unit (Kilogram) to this unit
...
public class WeightMeasurement {
	 ...
	 public WeightMeasurement add(WeightMeasurement other) {
	     if(other == null) {
